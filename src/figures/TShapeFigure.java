...
public class TShapeFigure extends Figure {
    public TShapeFigure(TypeFigure type, int rowPosition, GameBoard board) {
        super(type, board);
        for (int i = 0; i <COORDINATES_NUMBER - 2; i++) {
            this.coordinates[i] = new Coordinates(rowPosition, i);
        }
        this.coordinates[COORDINATES_NUMBER - 2] = new Coordinates(rowPosition + 1, 2);
    }
